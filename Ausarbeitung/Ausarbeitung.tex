...
\begin{document}
    ...
    \section{Einleitung}
    In den Bereichen der Control-Theory, Kosmologie und allgemein in der Berechnung von Wellen gibt es zahlreiche Anwendungen, in denen die Berechnung des \textit{Areasinus Hyperbolicus} ($arsinh(x)$) von großer Bedeutung ist.~\cite{QUELLE_DANIEL}
