...
/*
 * Series Approximation of arsinh for [-1; +1] using the Taylor series around 0
 *
 * Arguments: |x| < 1
 * 
 * Features: fixed number of series terms to avoid case distinctions
 * x^2 as base for terms of the series
 * lookup-table for coefficients and horner scheme to optimize calculation of series terms
 *
 ...
 * lookup-table for coefficients and horner scheme to optimize calculation of series terms
 * 
 * Returns: exact value of rest-series for |x|>4
...
/*
 * Computes the Taylor Series for ln(x) around 1, applicable for 0<|x|<=2
 *
 * Arguments: 0.667 < x < 1.333
 * 
 * Features: Fixed number of calculated series terms -> No case distinction
